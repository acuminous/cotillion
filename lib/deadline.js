...
function describeWaiting(waiting, preamble) {
  ...
  return `${preamble} ${listNames(waiting.map((wait) => wait.name))} to ${waiting[0].lifecycle}`;
}
...
module.exports = { createDeadline, listNames, timeoutsOf };
